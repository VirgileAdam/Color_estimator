...
The accompanying **Percepta Technical Manual** develops the complete processing pipeline, mathematical model, individual rendering algorithms, adaptive defaults, perception theory, animation equations, export guidance and limitations.
